...
require_once 'modules' . $ds . 'api' . $ds . 'lib' . $ds . 'jobqueue.class.php';
...
function __autoload_elastica ($class) {
    ...
    $fullPath = PF_BASE . '/modules/thirdparty/elastica/lib/' . $path . '.php';
...
$pf_inc .= PF_BASE . $ds . 'modules' . $ds . 'thirdparty' . $ds . 'smarty' . $ds . 'sysplugins' . $ps;
