	...
	*/
    ...
    public function fetch($template, $cache_id = null, $compile_id = null, $parent = null, $display = false)
    {
        ...
        $_template = $this->createTemplate ($template, $cache_id, $compile_id, $parent, false);
				...
				$errorBitstring = $this->debugging ? error_reporting() : error_reporting(isset($this->error_reporting)
               ? $this->error_reporting : error_reporting() & ~E_NOTICE);

				$pf_handler = new PFErrorHandler();
				$_smarty_old_error_level = error_reporting();
				set_error_handler(array($pf_handler, 'ErrorHandler'), $errorBitstring);
        ...
        if (isset($this->error_reporting)) {
					set_error_handler(array($pf_handler, 'ErrorHandler'), $_smarty_old_error_level);
