...
class Smarty_Compiler extends Smarty {
    ...
    function Smarty_Compiler()
    {
        ...
        $this->_obj_start_regexp = '(?:' . $this->_dvar_regexp . '(?:' . $this->_obj_ext_regexp . ')+)';
				...
				// ETJ - Updated this to support 2 levels of object nesting, because, hey, more is better right?
    ...
    function _compile_section_start($tag_args)
    {
        ...
        foreach ($attrs as $attr_name => $attr_value) {
            switch ($attr_name) {
                case 'loop':
										$output .= "{$section_props}['loop'] = (is_array(\$_loop=$attr_value)||is_a(\$_loop=$attr_value,'ArrayObject')) ? count(\$_loop) : max(0, (int)\$_loop); unset(\$_loop);\n"; 
                    break;
