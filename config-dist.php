...
define('PF_SHOP_GATEWAY_STRIPE_TEST_SECRET_KEY', '');
define('PF_SHOP_GATEWAY_STRIPE_TEST_PUBLISH_KEY', '');
define('PF_SHOP_GATEWAY_STRIPE_LIVE_SECRET_KEY', '');
define('PF_SHOP_GATEWAY_STRIPE_LIVE_PUBLISH_KEY', '');
define('PF_SHOP_GATEWAY_STRIPE_SCRIPT', 'https://js.stripe.com/v1/');

define('PF_SHOP_GATEWAY_PAYPAL_TEST_REQUEST', true);
define('PF_SHOP_GATEWAY_PAYPAL_LOG', '%%PHING_PROTEAN_BASEDIR%%/logs/pf_paypal.log');
define('PF_SHOP_GATEWAY_PAYPAL_SELLER_EMAIL', '');

define('PF_USPS_RATECALCULATOR_USERNAME', '');
